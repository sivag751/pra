...
$replaceurl=substr_replace($url ,"", -24);
$replaceurl;
...
<body>
 ...
 <div class="banner">
    ...
    <section class="blog spad1">
        <div class="container">
<h2 class="headtitle" title="<?php echo $jname;?>"> <?php echo $jname;?> - Editorial / Board Members </h2>
...
<div class="row">
 ...
 <?php
   $query=mysqli_query($db,"select * from board_members_tbl where journal_id='$jid' and status='1' order by order_num ASC");
...
<div class="card">
    <div class="box">
        <div class="img">
            <img src="uploads/boardmembersimgs/<?php echo $data['memberimg'];?>">
        </div>
			<h3 class="ebtype"><?php echo $data['eb_type'];?></h3>
        <h2><?php echo $data['author_name'];?><br></h2>
        <p> <?php echo $data['university'];?>,<br/><?php echo $data['country'];?></p>
        <span>
            <ul>
                 <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal<?php echo $data['member_id'];?>">Biography</button>
 ...
 <!-- Modal -->
  <div class="modal fade" id="myModal<?php echo $data['member_id'];?>" role="dialog">
    <div class="modal-dialog">
    
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header" style="display:initial;">
<h4 class="modal-title" style="text-align: center;color: #0098a3;font-size: 20px;font-weight: 600;">Author Name: <?php echo $data['author_name'];?></h4>
        </div>
