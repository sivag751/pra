			 ...
			 <?php $innerbanner=mysqli_fetch_array(mysqli_query($db,"SELECT * FROM inner_banners WHERE `journal_id`='$jid'"));
               ?>
                ...
                <div class="item active">
                    <img src="uploads/journalbanners/<?php echo $innerbanner['inner_banner'];?>" alt="" class="img-responsive" />
                </div>
...
<div class="col-lg-9 col-md-9 col-sm-9">
 <?php if ($imfact_factor!=""){?>
         ...
         <?php }?>
		 <h4 class="subtitle" title="About the Journal">Special Issue</h4>
    <?php
				 $query=mysqli_query($db,"select * from special_issues_tbl where journal_id='$jid' order by special_id ASC");
...
?>
					...
					<h4 class="aname" title="<?php echo $adata['title'];?>"> <?php echo $adata['title'];?></h4>
