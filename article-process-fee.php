...
$replaceurl=substr_replace($url ,"", -20);
$replaceurl;
...
<h4 class="subtitle">Article Process & Fee </h4>
  <?php
				 $query=mysqli_query($db,"select * from article_in_procee_fee_tbl where journal_id='$jid' order by article_fee_id ASC");
...
?>
					...
					<div class="col-lg-10 col-md-10 col-sm-10" style="text-align:left;padding-left:0px;">
					<h4 class="aname" title="<?php echo $adata['article_name'];?>"> <?php echo $adata['article_name'];?></h4>
					<p><?php echo $adata['description'];?></p>
					</div>
					</div>
	<?php }  
	?>
